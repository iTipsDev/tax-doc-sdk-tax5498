...
import irs.fdxtax641.jsonserializers.Tax5498Serializer;
import irs.fdxtax641.map2objects.Map2Tax5498;
import org.taxdataexchange.core.pdfbuilders.Tax5498PdfBuilder;
...
public class Tax5498DocumentGenerator {
    ...
    private void processOneRow(
        ...
        Tax5498 obj = Map2Tax5498.generate( row );
        {
            String asJson = Tax5498Serializer.serialize( obj );
    ...
    private void processCsvForCompany(
        ...
        // CSV file
        String csvFileName  = "Tax5498.csv";
        ...
        String outputFileName = "Tax5498.rows.json";
    ...
    public static void main(String[] args) {
        ...
        Tax5498DocumentGenerator generator = new Tax5498DocumentGenerator( );
