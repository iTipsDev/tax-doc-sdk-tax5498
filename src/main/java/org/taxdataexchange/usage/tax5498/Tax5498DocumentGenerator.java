package org.taxdataexchange.usage.tax5498;

import org.taxdataexchange.core.utils.*;
import org.taxdataexchange.docs.tax5498.models.*;
import org.taxdataexchange.docs.tax5498.utils.*;

public class Tax5498DocumentGenerator {
    ...
    public static TaxDataList sampleData( ) {
        ...
        // Sample data
        // -----------------------------------------------------------------
        TaxData taxData = SampleData.sampleTaxData( "Tax5498" );
    ...
    public static byte[] sampleQrAsPng( ) {
        ...
        Tax5498PdfBuilder pdfBuilder = new Tax5498PdfBuilder( );
        byte[] bytes = pdfBuilder.buildQr( taxDataList );

        String filePath = "samples/Tax5498.qr.png";
    ...
    public static void samplePdf( ) {
        ...
        String filePath = "samples/Tax5498.sample.pdf";
        FileUtils.bytesToFile( pdfBytes, filePath );
        System.out.println( filePath );

        String filePathPng = "samples/Tax5498.sample.png";
    ...
    public static void addCoverPage() {
        ...
        String filePath2 = "samples/Tax5498.cover.pdf";
        FileUtils.bytesToFile( combinedBytes, filePath2 );
    ...
    public static void insertQrCode() {
        ...
        String filePath2 = "samples/Tax5498.inserted.pdf";
        FileUtils.bytesToFile( combinedBytes, filePath2 );
    ...
    public static void main(String[] args) {
        ...
        System.out.println( "Tax5498DocumentGenerator Begin" );
        ...
        System.out.println( "Tax5498DocumentGenerator Done" );
